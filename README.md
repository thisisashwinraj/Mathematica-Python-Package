...
**Note:**
Mathematica runs on all operating systems, is quick to install, and is available for free use. No mathematica version supports Python 2.x. Mathematica's plotting capabiliies requires [matplotlib](https://matplotlib.org/) (>= 2.1.1) and seaborn (>= 0.9.0) packages.
